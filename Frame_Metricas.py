...
class FrameMetricas:
    ...
    def build(self, parent):
        ...
        self.f_graf = ctk.CTkFrame(dash_outer, fg_color=COLOR_BG_CARD, corner_radius=6,
                                    border_width=1, border_color=COLOR_BORDER)
        self.f_graf.pack(expand=True, fill="both")
        ctk.CTkFrame(self.f_graf, fg_color=COLOR_ACCENT, height=4, corner_radius=0).pack(fill="x")
